        ...
        <div class="row g-5">
            ...
            <div class="col-lg-2 col-md-6">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2"><a href="<?= site_url('ciencia'); ?>" class="text-light opacity-75 text-decoration-none">Investigación</a></li>
            ...
            <!-- Columna 3: Compañía -->
            <div class="col-lg-2 col-md-6">
                <h6 class="fw-semibold text-white mb-3">Compañía</h6>
                <ul class="list-unstyled">
            ...
            <div class="col-lg-4 col-md-12 text-lg-end">
                <div class="mb-4">
                    <h6 class="fw-semibold text-white mb-3">Contáctanos</h6>
                    <p class="text-light opacity-75 mb-1">+52 (55) 1234 5678</p>
                    <p class="text-light opacity-75">contacto@biomedicssouls.com</p>
                </div>

                <div class="mt-5 pt-4 border-top border-secondary">
                    <small class="text-light opacity-50">
                        © <?= date('Y'); ?> Biomedics Souls. Todos los derechos reservados.
                    </small>
                </div>

                <div class="mt-3">
                    <a href="#" class="text-light opacity-50 text-decoration-none me-3">Privacidad</a>
                    <a href="#" class="text-light opacity-50 text-decoration-none">Términos</a>
                </div>
            </div>
        </div>
    </div>
