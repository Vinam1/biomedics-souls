...
$title = 'Gestión de Atributos | Biomedcs Souls';
?>
    ...
    <div class="row g-4">
        ...
        <div class="col-xl-9">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mb-5">
                <div>
                    <h1 class="display-6 fw-bold mb-1">Gestión de Atributos</h1>
                    <p class="text-muted mb-0">Administra etiquetas y categorías de productos.</p>
                </div>
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="card-modern p-4 bg-white h-100">
                        <div class="d-flex align-items-center gap-3 mb-4">
                            ...
                            <div>
                                <h5 class="fw-semibold mb-1">Categorías</h5>
                                <p class="text-muted small mb-0">Organiza tus productos por categorías</p>
                            </div>
                        </div>
                        <div class="d-flex justify-content-between align-items-center">
                            <span class="badge bg-primary fs-6 px-3 py-2"><?= $categoriesCount ?? 0; ?> categorías</span>
                            <a href="<?= site_url('admin/categorias'); ?>" class="btn btn-primary">
                                <i class="fas fa-eye me-1"></i> Gestionar Categorías
                            </a>
                        </div>
                    </div>
                </div>
