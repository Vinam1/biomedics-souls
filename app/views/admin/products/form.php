...
$cantidadEnvase    = $product['cantidad_envase'] ?? '';
$cantidadUnidades  = $product['cantidad_unidades'] ?? '';
                    ...
                    <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between gap-3 mb-5">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-muted mb-0">Completa la informaciÃ³n detallada del producto.</p>
                            </div>
                        </div>
                    ...
                    <form method="post" action="" enctype="multipart/form-data" class="row g-4">
                            ...
                            <div class="card border-0 shadow-sm">
                                <div class="card-body p-4">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            <label class="form-label fw-semibold">PresentaciÃ³n</label>
                                        ...
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <input type="text" name="cantidad_unidades" class="form-control rounded-4" 
                                                   value="<?= htmlspecialchars($cantidadUnidades); ?>" 
                                                   placeholder="Ej: 30 cÃ¡psulas, 60 tabletas, 1 frasco">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group rounded-4">
                                                ...
                                                <input type="number" step="0.01" name="precio" class="form-control" 
                                                       required value="<?= htmlspecialchars($product['precio'] ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label fw-semibold">Precio con descuento (opcional)</label>
                                            <div class="input-group rounded-4">
                                                <span class="input-group-text">$</span>
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <div class="input-group mb-3">
                                                <select id="select-etiqueta" class="form-select rounded-4">
                                                ...
                                                <button type="button" class="btn btn-primary px-4 rounded-end-4" onclick="openQuickAddModal('etiqueta')">
                                                    <strong>+</strong>
                                                </button>
                                            </div>
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <small class="text-muted">Badges que aparecen en la tarjeta del producto</small>
                                                <a href="<?= site_url('admin/atributos/etiquetas'); ?>" class="text-decoration-none" target="_blank">
                                                    <small class="text-primary fw-semibold">Gestionar etiquetas â†’</small>
                                                </a>
                                            </div>
                                        ...
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <small class="text-muted">Describe para quÃ© sirve el producto.</small>
                                        </div>
                        ...
                        <div class="col-12">
                            <div class="card border-0 shadow-sm">
                                <div class="card-body p-4">
                                    <div class="d-flex align-items-center gap-3 mb-4">
                                        <i class="fas fa-search text-indigo fs-3"></i>
                                        <h2 class="h5 fw-semibold mb-0">SEO</h2>
                                    </div>
                                    <div class="row g-3">
                                        <div class="col-12 col-lg-6">
                                            <label class="form-label fw-semibold">SKU</label>
                                            <input type="text" name="sku" class="form-control rounded-4" required value="<?= htmlspecialchars($product['sku'] ?? ''); ?>">
                                        </div>
                                        <div class="col-12 col-lg-6">
                                            <label class="form-label fw-semibold">Slug</label>
                                            <input type="text" name="slug" class="form-control rounded-4" required value="<?= htmlspecialchars($product['slug'] ?? ''); ?>">
                                        </div>
                                        <div class="col-12 col-lg-6">
                                        ...
                                        <div class="col-12 col-lg-6 d-flex align-items-center pt-4">
                                            <div class="form-check form-switch">
                                                ...
                                                <label class="form-check-label fw-semibold" for="destacado">Producto destacado</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-5 pt-5 border-top">
                                        <div class="d-flex align-items-center gap-3 mb-4">
                                            <i class="fas fa-images text-pink fs-3"></i>
                                            <h2 class="h5 fw-semibold mb-0">ImÃ¡genes del producto</h2>
                                        </div>
                                        <input type="file" name="imagenes[]" id="imagenesInput"
                                               class="form-control rounded-4 mb-3" accept="image/*" multiple>
                                        <div class="d-flex justify-content-between align-items-center gap-3 flex-wrap mb-3">
                                            <p class="text-muted mb-0">Las imágenes se muestran al seleccionarlas, puedes reordenarlas arrastrando y la que quede en primera posición será la principal.</p>
                                        ...
                                        <div id="image-manager" class="image-manager">
                                            ...
                                            <div
                                                ...
                                                class="image-grid"
                                                data-existing-images="<?= htmlspecialchars(json_encode(array_map(static function ($image) {
                                                    return [
                                                        'id' => (int) ($image['id'] ?? 0),
                                                        'url' => asset_url('img/products/' . ($image['url_imagen'] ?? '')),
                                                        'filename' => $image['url_imagen'] ?? '',
                                                        'principal' => !empty($image['es_principal']),
                                                    ];
                                                }, $currentImages)), ENT_QUOTES, 'UTF-8'); ?>"
                                            >
                                                <?php foreach ($currentImages as $index => $image): ?>
                                                    <div class="image-card image-card--static">
                                                        ...
                                                        <div class="image-card__frame">
                                                            <img
                                                                src="<?= htmlspecialchars(asset_url('img/products/' . ($image['url_imagen'] ?? ''))); ?>"
...
<!-- Modal para agregar atributos rÃ¡pidamente -->
        ...
        <div class="modal-content rounded-4 border-0 shadow-lg">
            ...
            <div class="modal-body pt-4">
                <form id="quickAddForm">
                    ...
                    <!-- Tipo de atributo -->
                    <div class="mb-4">
                        <label class="form-label fw-semibold">Tipo de atributo</label>
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="attribute_type" id="type-etiquetas" value="etiquetas" checked>
                                    <label class="form-check-label fw-semibold" for="type-etiquetas">
                                        <i class="fas fa-tags text-warning me-2"></i>Etiqueta
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="dynamic-fields" class="d-none">
                        <div class="row g-3">
                            <div class="col-12">
                                <label class="form-label fw-semibold" id="name-label">Nombre <span class="text-danger">*</span></label>
                            ...
                            <div class="col-12" id="description-field" style="display: none;">
                                <label class="form-label fw-semibold">DescripciÃ³n <span class="text-danger">*</span></label>
                                <textarea class="form-control rounded-4" id="attribute-description" rows="3" placeholder="Describe brevemente este atributo..."></textarea>
                            </div>

                            <div class="col-12" id="icon-field" style="display: none;">
                                <label class="form-label fw-semibold">Ãcono de Font Awesome</label>
                                <div class="d-flex align-items-center gap-3">
                                    <div class="fs-2" id="icon-preview">
                                        <i class="fas fa-heart"></i>
                                    </div>
                                    <input type="text" class="form-control rounded-4" id="attribute-icon" placeholder="fa-heart, fa-star, fa-check..." value="fa-heart">
                                </div>
...
<script>
    window.productoFormData = {
        ...
        currentImages: <?= json_encode(array_map(static function ($image) {
            return [
                'id' => (int) ($image['id'] ?? 0),
                'url' => asset_url('img/products/' . ($image['url_imagen'] ?? '')),
                'filename' => $image['url_imagen'] ?? '',
