                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <small class="text-muted">Solo letras minusculas, numeros y guiones. Se autogenera desde el nombre si no lo editas manualmente.</small>
                                        </div>

                                        <div class="col-12 col-lg-6">
                                            <label for="estatus" class="form-label fw-semibold">Estatus</label>
                                            <select id="estatus" name="estatus" class="form-select rounded-4">
