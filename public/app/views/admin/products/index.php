    ...
    <div class="row g-4">
        ...
        <div class="col-xl-9">
            ...
            <form method="get" class="row g-3 mb-4 align-items-end">
                ...
                <div class="col-md-2"><label class="form-label">Estatus</label><input type="text" name="estatus" class="form-control rounded-4" placeholder="Buscar estatus" value="<?= htmlspecialchars($selectedStatus); ?>"></div>
                            ...
                            <?php foreach ($products as $product): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                        <?php if ($statusLabel !== ''): ?>
                                            <span class="badge rounded-pill <?= $isOutOfStock ? 'text-bg-danger' : 'text-bg-light border'; ?>">
                                                <?= htmlspecialchars($statusLabel); ?>
                                            </span>
                                        <?php else: ?>
                                            <span class="text-muted">Sin estatus</span>
                                        <?php endif; ?>
                                    </td>
