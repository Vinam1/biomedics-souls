            ...
            <div class="col-xl-8">
                <div class="quiz-card p-4 p-lg-5 rounded-4 shadow-sm" data-animate="fade-up">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
                        <div>
                            <span class="eyebrow-pill mb-3">Recomendación guiada</span>
                            <h1 class="h3 fw-bold mb-2">Quiz interactivo</h1>
                            <p class="text-muted mb-0">Responde una pregunta por pantalla y descubre cuál es tu mejor ruta de bienestar.</p>
                        </div>
...
const renderResult = () => {
    ...
    content.innerHTML = `
        ...
        <div class="d-grid gap-3">
            ...
            <a href="<?= site_url('catalogo'); ?>" class="btn btn-primary btn-lg" data-animate="fade-up" data-animate-delay="220">Ver productos recomendados</a>
        </div>
    `;
