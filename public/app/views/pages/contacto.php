...
<div class="container py-5">
    ...
    <div class="row g-4 justify-content-center">
        <div class="col-lg-5 col-md-6">
            <div class="card border-0 shadow-sm h-100 p-4 rounded-4">
                ...
                <a href="https://wa.me/525647969316" target="_blank" class="btn btn-success btn-lg w-100 rounded-4 py-3 fw-semibold">Iniciar Chat en WhatsApp →</a>
            </div>
        </div>
    ...
    <div class="row g-5 mt-5 pt-5 border-top">
        <div class="col-md-4 text-center"><div class="mb-3"><i class="bi bi-geo-alt fs-1 text-muted"></i></div><h5 class="fw-semibold">Ubicación</h5><p class="text-muted mb-0">Av. Paseo del Titanio 42-B Joyas de Cuautitlán, Cuautitlán. México</p></div>
        <div class="col-md-4 text-center"><div class="mb-3"><i class="bi bi-telephone fs-1 text-muted"></i></div><h5 class="fw-semibold">Teléfono</h5><p class="text-muted mb-0">+52 (56) 4796 9316</p></div>
