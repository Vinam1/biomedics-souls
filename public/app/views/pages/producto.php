...
<section class="page-shell py-5">
    <div class="container product-page">
        <nav class="breadcrumb-custom mb-4" data-animate="fade-up">
        ...
        <?php if (!empty($flashSuccess)): ?>
            <div class="alert alert-success rounded-4 alert-auto-close"><?= htmlspecialchars($flashSuccess); ?></div>
        <?php endif; ?>
            ...
            <div class="col-lg-6" data-animate="fade-up">
                ...
                <div class="product-copy-panel">
                    ...
                    <div class="product-feature-grid">
                        <article class="product-feature-card" data-animate="fade-up" data-animate-delay="80">
                        ...
                        <article class="product-feature-card" data-animate="fade-up" data-animate-delay="140">
                        ...
                        <article class="product-feature-card" data-animate="fade-up" data-animate-delay="220">
