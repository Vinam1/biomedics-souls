...
<div class="container py-5">
    ...
    <?php if (!empty($flashSuccess)): ?>
        <div class="alert alert-success rounded-4 mb-4"><?= htmlspecialchars($flashSuccess); ?></div>
    <?php endif; ?>
                                    ...
                                    <td class="text-center">
                                        <div class="d-inline-flex align-items-center border rounded-3">
                                            ...
                                            <form action="<?= site_url('carrito/actualizar/' . $product['id']); ?>"
                                                ...
                                                <button type="submit"
                                                        class="btn btn-link text-dark px-3 py-1"
                                                        <?= !empty($item['is_out_of_stock']) ? 'disabled' : ''; ?>>+</button>
                                            </form>
                                        </div>
                                    </td>
            ...
            <div class="col-lg-4">
                <div class="checkout-panel p-4 sticky-top rounded-4 shadow-sm" style="top: 1.5rem;">
                    ...
                    <?php if (!empty($hasOutOfStockItems)): ?>
                        <button type="button" class="btn btn-primary btn-lg w-100 rounded-4 py-3 fw-semibold" disabled>
                            Proceder al pago
                        </button>
                    <?php else: ?>
